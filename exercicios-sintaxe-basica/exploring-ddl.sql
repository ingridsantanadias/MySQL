...
insert into bankAccounts (Ag_num,Ac_num,Saldo) values (156,264354,0);
...
-- alter table_nome modify column nome_atributo tipo_dado condição;
...
insert into bankClient (ClientAccount,CPF,RG,Nome,Endereço,Renda_mensal)  value (1,12345678913,123456789,'Fulano','rua azul',6500.00);
